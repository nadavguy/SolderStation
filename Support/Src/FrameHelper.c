...
//		Paint_DrawRectangle(0, 80, 128, 160, BLACK, DOT_PIXEL_1X1, DRAW_FILL_FULL);
		...
		Paint_DrawString_EN(10, 136, "1", &Font8, BLACK, WHITE);
		Paint_DrawString_EN(10, 116, "2", &Font8, BLACK, WHITE);
		Paint_DrawString_EN(10, 96, "3", &Font8, BLACK, WHITE);
		Paint_DrawString_EN(10, 86, "[A]", &Font8, BLACK, WHITE);
