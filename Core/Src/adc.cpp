...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = ADC1_IN1_CurrentMeasurement_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC1_IN1_CurrentMeasurement_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(ADC1_IN1_CurrentMeasurement_GPIO_Port, ADC1_IN1_CurrentMeasurement_Pin);
...
{
	int32_t ampReading = 0;
	ampReading = HAL_ADC_GetValue(hadc) - 620;
	if (ampReading < 0)
	{
		ampReading = 0;
	}
